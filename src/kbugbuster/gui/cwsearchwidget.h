...
#include "ui_cwsearchwidget_base.h"
...
class CWSearchWidget_Base : public QWidget, public Ui::CWSearchWidget_Base
{
public:
  CWSearchWidget_Base( QWidget *parent ) : QWidget( parent ) {
    setupUi( this );
  }
};
...
public:
    CWSearchWidget( QWidget* parent = 0 );
    ~CWSearchWidget();
