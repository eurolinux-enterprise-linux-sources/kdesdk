...
public:
    ...
    explicit CWLoadingWidget( WidgetMode mode = TopFrame, QWidget* parent = 0);
    explicit CWLoadingWidget( const QString &text, WidgetMode mode = TopFrame,
                	      QWidget* parent = 0);
    ~CWLoadingWidget();
